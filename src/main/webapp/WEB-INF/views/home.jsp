	...
	<div class="container">
		<nav class="blog-nav">
			<a class="blog-nav-item active" href="#">Home</a> <a
				class="blog-nav-item" href="<c:url value = "/member"/>">LogIn</a> <a
				class="blog-nav-item" href="<c:url value = "/member/insert"/>">Join</a>
		</nav>
	</div>
</div>
<body class="container">
	<div class="jumbotron">
		<h1>Hello, world!</h1>
		<p class="timer">The time on the server is 00:00:00.</p>
	</div>
